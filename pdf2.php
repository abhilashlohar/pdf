...
//echo $fontname;
$html='<span style="font-size:15">'.$fontname.'</span>';
$html.='<span style="font-family:'.$fontname.';font-size:15">'.$fontname.'</span>';
$html.='<span style="font-family:Open Sans;font-size:15">'.$fontname.'</span>';
$html.='<span style="font-family:Open Sans;font-size:15">Quotation prepared for</span>';
$html.='<span style="font-size:15">Quotation prepared for</span>';
