...
$toolcopy2 = '<table border="0"  cellspacing="10">';
$toolcopy2 .= '<tr style="background-color:rgb(0,160,227);color:#fff;"><th width="300px"><span style="font-size:12;">'.$date_itinary.'</span></th><th width="300px"><span style="font-size:12;">'.$arrive.'</span></th></tr>';
if(!empty($file)){
